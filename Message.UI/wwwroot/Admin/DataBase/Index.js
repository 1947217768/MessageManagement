layui.use(['form', 'element', 'layer', 'table', 'laytpl'], function () {
    ...
    var tableIns = table.render({
        elem: '#dataTable',
        url: '/Admin/DataBase/LoadData?iPageId=' + iPageId + '&iMethodId=' + iLoadDataMethodeId,
        cellMinWidth: 95,
        page: true,
        height: "full-125",
        limits: [10, 15, 20, 25],
    ...
    function addManager(edit) {
        ...
        var index = layui.layer.open({
            ...
            anim: 1,
            area: ['800px', '90%'],
            content: '/Admin/DataBase/AddOrModify?iPageId=' + iPageId + '&iMethodId=' + iAddorModifyMethodeId,
    ...
    $("#btnDelete").click(function () {
        ...
        if (data.length > 0) {
            ...
            layer.confirm('确定删除选中的数据？', { icon: 3, title: '提示信息' }, function (index) {
                $.ajax({
                    type: 'POST',
                    url: '/Admin/DataBase/DeleteRange?iPageId=' + iPageId + '&iMethodId=' + iDeleteMethodeId,
                    data: { arrId: arrId },
                    dataType: "json",
                    headers: {
